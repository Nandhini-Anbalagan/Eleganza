...
class DBManager extends MySQLConnection{
	...
	*/
	...
	public function editBuyerLandingPage($data){
		$query = $this->myDB->prepare("UPDATE subscriber_landing_page SET LP1_EN_TITLE=?,LP1_EN_SUB1=?,LP1_EN_SUB2=?,LP1_EN_SUB3=?,LP1_EN_SUB4=?,LP1_EN_SUB5=?,LP1_EN_BTN=?,LP2_EN_TITLE=?,LP2_EN_NAME_LBL=?,LP2_EN_ADDRESS_LBL=?,LP2_EN_EMAIL_LBL=?,LP2_EN_PHONE_LBL=?,LP2_EN_BTN=?,LP3_EN_TITLE=?,LP3_EN_SUB1=?,LP3_EN_SUB2=?,LP3_EN_SUB3=?,LP1_FR_TITLE=?,LP1_FR_SUB1=?,LP1_FR_SUB2=?,LP1_FR_SUB3=?,LP1_FR_SUB4=?,LP1_FR_SUB5=?,LP1_FR_BTN=?,LP2_FR_TITLE=?,LP2_FR_NAME_LBL=?,LP2_FR_ADDRESS_LBL=?,LP2_FR_EMAIL_LBL=?,LP2_FR_PHONE_LBL=?,LP2_FR_BTN=?,LP3_FR_TITLE=?,LP3_FR_SUB1=?,LP3_FR_SUB2=?,LP3_FR_SUB3=?,bg_img1=?,bg_img2=?,bg_img3=? WHERE id = ?");
		return $query->execute(array($data["LP1_EN_TITLE"],$data["LP1_EN_SUB1"],$data["LP1_EN_SUB2"],$data["LP1_EN_SUB3"],$data["LP1_EN_SUB4"],$data["LP1_EN_SUB5"],$data["LP1_EN_BTN"],$data["LP2_EN_TITLE"],$data["LP2_EN_NAME_LBL"],$data["LP2_EN_ADDRESS_LBL"],$data["LP2_EN_EMAIL_LBL"],$data["LP2_EN_PHONE_LBL"],$data["LP2_EN_BTN"],$data["LP3_EN_TITLE"],$data["LP3_EN_SUB1"],$data["LP3_EN_SUB2"],$data["LP3_EN_SUB3"],$data["LP1_FR_TITLE"],$data["LP1_FR_SUB1"],$data["LP1_FR_SUB2"],$data["LP1_FR_SUB3"],$data["LP1_FR_SUB4"],$data["LP1_FR_SUB5"],$data["LP1_FR_BTN"],$data["LP2_FR_TITLE"],$data["LP2_FR_NAME_LBL"],$data["LP2_FR_ADDRESS_LBL"],$data["LP2_FR_EMAIL_LBL"],$data["LP2_FR_PHONE_LBL"],$data["LP2_FR_BTN"],$data["LP3_FR_TITLE"],$data["LP3_FR_SUB1"],$data["LP3_FR_SUB2"],$data["LP3_FR_SUB3"],$data["defaultBackground1"],$data["defaultBackground2"],$data["defaultBackground3"], $data['id']));
	}
