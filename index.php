      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" target="_blank" href="/sponsor/?a=2&l=e&s=w&ind=r">
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" target="_blank" href="/sponsor/?a=2&l=e&s=w&ind=m">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
                </div>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" target="_blank" href="/sponsor/?a=2&l=e&s=w&ind=s">
              <div class="portfolio-hover">
                <div class="portfolio-hover-content">
                  <i class="fa fa-plus fa-3x"></i>
                </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <h3 class="section-subheading text-muted">Eleganza Partners</h3>
      </div>
    </div>
    <div class="row">
<div class="column">
<img src="img/about/maserati.jpg" style="width:100%">
<img src="img/about/ROCOCO.jpg" style="width:100%">
</div>
<div class="column">
...
<img src="img/about/MercedesSilverstar.png" style="width:100%">
</div>
    </div>
    <div class="row">
      <div class="col-lg-12 text-center">
    <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#">Show More Partners</a>
  </div>
</div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <h3 class="section-subheading text-muted">Team Eleganza</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-4">
      ...
      <div class="col-sm-4">
        <div class="team-member">
          ...
          <h4>MATTEO FIORILLI</h4>
          <p class="text-muted">Director Business Development</p>
          <ul class="list-inline social-buttons">
            <li class="list-inline-item">
              <a href="#">
                <i class="fa fa-twitter"></i>
          ...
          <div class="col-md-12">
            ...
            <div class="col-lg-12 col-sm-offset-0 col-xs-10 col-xs-offset-1 col-xxs-12">
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input class="form-control" type="text" name="areas" id="inputAreas1" placeholder="Enter Your Address" required>
										</div>
